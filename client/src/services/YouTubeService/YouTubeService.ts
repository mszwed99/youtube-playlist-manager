...
export const getVideoDetailsById = (id: string) => axios.get(`https://www.googleapis.com/youtube/v3/videos?part=snippet&id=${id}&key=${process.env.REACT_APP_YT_API_KEY}`);